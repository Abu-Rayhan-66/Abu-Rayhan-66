<img src="https://raw.githubusercontent.com/Abu-Rayhan-66/Abu-Rayhan-66/main/Assets/Abu%20RAYHAN%20banner.jpg" width="100%"/>
...
-  For creating user interface i prefer using react js and next js.
-  For styling i use tailwind because it's givs us some awesome utility which help us to create user interface efficiently.
-  I love to use Typescript to handle unwanted errors in development time.
-  For state management i prefer to use redux but sometimes i also use context api.
-  For database i use Mongodb and mongoose.
-  For server i use express, node js.
